Welcome to the Sparkify Analytics AWS Datawarehouse
===================================================
...
You will need to fill in the necessary fields in the *dwh.cfg* file.
...
* Fill in the appropriate config varibles in *dwh.cfg*
...
> *IMPORTANT!* Everytime the create_tables script runs it will result in a blank set of tables.
